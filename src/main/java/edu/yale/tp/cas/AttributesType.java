...
public class AttributesType {
     ...
     * 
     */
    public AttributesType(final XMLGregorianCalendar authenticationDate, final boolean longTermAuthenticationRequestTokenUsed, final boolean isFromNewLogin, final List<Object> any) {
